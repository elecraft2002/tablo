...
export default function Scene({ offsetY, setMainRef }) {
    ...
    const logo = <svg xmlns="http://www.w3.org/2000/svg" width="41.631" height="62.283" viewBox="0 0 41.631 62.283">
                        ...
                        <div className='creator__container'>
                            <div style={{ margin: "1rem" }}>
                                ...
                                <div className='creator__links'>
                                    <a rel='noopener' href='https://www.vojtechsuchanek.cz/cs-cz' target='_blank'>{logo}</a>
